...
type Student struct {
	...
	Age   int32   `protobuf:"varint,1,opt,name=age,proto3" json:"age,omitempty"` // 可以不从1开始, 不重复即可. 19000~19999 不可用.
	Name  string  `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	P     *People `protobuf:"bytes,3,opt,name=p,proto3" json:"p,omitempty"`                 //嵌套结构体
...
type Student_Teacher struct {
	Teacher string `protobuf:"bytes,6,opt,name=teacher,proto3,oneof"` // 取其中之一, 编号不能重复.
}
...
var file_myproto_proto_rawDesc = []byte{
	...
	0x04, 0x62, 0x6a, 0x34, 0x30, 0x12, 0x1e, 0x0a, 0x03, 0x53, 0x61, 0x79, 0x12, 0x0a, 0x2e, 0x70,
...
var file_myproto_proto_depIdxs = []int32{
	...
	2, // 2: pb.bj40.Say:input_type -> pb.People
	1, // 3: pb.bj40.Say:output_type -> pb.Student
...
// Bj40Client is the 2.client API for Bj40 service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type Bj40Client interface {
	Say(ctx context.Context, in *People, opts ...grpc.CallOption) (*Student, error)
}

type bj40Client struct {
	cc grpc.ClientConnInterface
}

func NewBj40Client(cc grpc.ClientConnInterface) Bj40Client {
	return &bj40Client{cc}
}

func (c *bj40Client) Say(ctx context.Context, in *People, opts ...grpc.CallOption) (*Student, error) {
	out := new(Student)
	err := c.cc.Invoke(ctx, "/pb.bj40/Say", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Bj40Server is the 1.server API for Bj40 service.
type Bj40Server interface {
	Say(context.Context, *People) (*Student, error)
}

// UnimplementedBj40Server can be embedded to have forward compatible implementations.
type UnimplementedBj40Server struct {
}

func (*UnimplementedBj40Server) Say(context.Context, *People) (*Student, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Say not implemented")
}

func RegisterBj40Server(s *grpc.Server, srv Bj40Server) {
	s.RegisterService(&_Bj40_serviceDesc, srv)
}

func _Bj40_Say_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(People)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Bj40Server).Say(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.bj40/Say",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Bj40Server).Say(ctx, req.(*People))
	}
	return interceptor(ctx, in, info, handler)
}

var _Bj40_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.bj40",
	HandlerType: (*Bj40Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Say",
			Handler:    _Bj40_Say_Handler,
		},
	},
